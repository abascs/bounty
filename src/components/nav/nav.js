...
function nav() {
  return (
    ...
    <div className="flex flex-col justify-around py-10 text-center md:text-left gap-10 order-2 lg:order-1">
      ...
      <p className="text-2xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Inventore, mollitia a! Fugit mollitia vel dicta facilis neque magnam commodi in. Veritatis nemo cumque quidem totam, repellendus officia sapiente consequatur officiis!</p>
